...
class ReportError {
 public:
  ...
  static void ImplementIsNotInterface(Decl *cd, Type *intfType);
  static void MainFunctionHadNotDeclare();
  static void MainFunctionIsCompatibleToStandard(Decl *fnDecl);
 ...
 // Errors used by semantic analyzer for array acesss & NewArray
  ...
  static void NewArrayTypeWrong(Type* type);
  ...
  static void ReturnOutFunction(ReturnStmt* Ret);
